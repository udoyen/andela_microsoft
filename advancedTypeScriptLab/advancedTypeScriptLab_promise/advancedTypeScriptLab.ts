...
// Finally, in order to run all of the rest of the code from the method, 
// instead of wrapping it inside of a .then() function, 
// we simply need to place the code below the asynchronously declared variables, 
// and use them as though they were declared synchronously.
